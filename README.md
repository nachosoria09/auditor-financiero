...
📄 [Manual de Usuario](./manual-auditor-financiero.md) — paso a paso, sin necesidad de saber programar.

## Estructura del repositorio

- `index.html` — la app (autocontenida, sin dependencias externas salvo Google Apps Script).
- `manual-auditor-financiero.md` — instrucciones de configuración y uso.
